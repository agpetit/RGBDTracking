...
public:
    ...
    core::behavior::MechanicalState<DataTypes>* getObject() {
        return mstate;
    }
	
    static std::string templateName(const ImageConverter<DataTypes,DepthTypes >* = NULL) {
        return DataTypes::Name()+ std::string(",")+DepthTypes::Name();
    }
